...
@reflectiveTest
class FlutterStyleExpiringTodosTest extends AnalysisRuleTest {
  @override
  void setUp() {
...
// TODO(alice) [2026/07/21]: fix
''',
      [lint(0, 32), error(diag.todo, 3, 29)],
    );
  }
...
''',
      [lint(0, 31), error(diag.todo, 3, 28)],
    );
  }
...
''',
      [lint(0, 29), error(diag.todo, 3, 26)],
    );
  }
...
/// TODO(alice): fix
''',
      [lint(0, 20), error(diag.todo, 4, 16)],
    );
  }
...
// TODO bad
''',
      [lint(13, 11), error(diag.todo, 16, 8)],
    );
  }
}
